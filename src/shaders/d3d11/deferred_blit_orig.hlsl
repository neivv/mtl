...
PS_OUTPUT main(VS_OUTPUT v)
{
    ...
    for (uint n = 0; n < light_count; n += 1) {
        ...
        float3 light_unkv3 = lights[i].unk16;
        float radius = lights[i].radius;
        float light_strength = lights[i].unk28;
        light_unkv3 *= 2;
        ...
        float light_mul = light_strength * 0.6 * 0.9 * distance_mul;
        ...
        float3 val = sprite_color * base_color_strength * light_unkv3;
